...
var valgtSak = "stotte";
function stotte(){
  studentpartiet.innerHTML = "Vi vil ha støtte til alle studenter";
  if(valgtParti==1){
    andrepartier.innerHTML = "<h1>Høyre</h1>Høyre vil styrke BSU-ordningen for å hjelpe unge inn på boligmarkedet. Det kan være vanskelig for unge å komme inn på boligmarkedet på grunn av høye boligpriser og økte egenkapitalkrav."+" Regjeringens utvidelse av BSU-ordningen hjelper flere unge inn i boligmarkedet.Sparing i forkant av kjøp er helt nødvendig for de fleste. "+"Høyre vil stimulere til sparing, og har derfor styrket BSU-ordningen betydelig. Allerede fra inntektsåret 2014 økte regjeringen grensen for maksimalt årlig innbetalt sparebeløp fra 20.000 kroner til 25.000 kroner, og hevet taket for samlet innbetalt sparebeløp fra 150.000 kroner til 200.000 kroner."+" I statsbudsjettet for 2016 ble sparebeløpet økt ytterligere til 300.000 kroner. Med regjeringens endringer vil BSU-ordningen igjen bli en ordning som kan gi ungdom mulighet til å spare et stort nok beløp til å klare egenkapitalkravet fra bankene.";
